...
export function set_metrics_callback(cb: Function): void;
export function scan_ble_devices(): Promise<void>;
...
export interface InitOutput {
  ...
  readonly start: () => void;
  readonly set_metrics_callback: (a: any) => void;
  readonly scan_ble_devices: () => any;
